...
**Example: Make Confetti with Python**
...
A `.command` file is just a bash script that macOS knows how to double-click and run in Terminal. More importantly, you can add it to your Login Items so it runs every time you log in.
...
You can double-click it now to test. Terminal should open, wait 10 seconds, send the message, and close.
